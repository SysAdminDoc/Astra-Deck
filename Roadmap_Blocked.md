...
- [ ] P0 — Tag and publish the v4.60.1 release
  ...
  Note (2026-08-19, drain #9): the tree is now at **v4.71.0**, all work is committed and origin/main is in sync, and all three profiles have no-CRX artifacts built at v4.71.0. The publish should target **v4.71.0**. Only the operator actions remain: tag, GitHub Release assets, and channel promotion (release-channels.json still points every channel at 4.59.0, twelve versions back).
