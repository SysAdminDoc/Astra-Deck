...
| **competitor userscript** | Header links (up to 10), native-feel watch-tab view, color-coded video age, transcript export presets, "header buttons that open NotebookLM/ChatGPT" | Astra has `transcriptAiHandoff` + `watchPageTabs` + `videoAgeColors` — but competitor userscript's polish is the benchmark. The popup has no equivalent quick-link header editor. |
...
- [ ] **P3 — Wheel-seek (NF9)**
- [ ] **P3 — Header quick-links editor parity with competitor userscript (10 slots)**
