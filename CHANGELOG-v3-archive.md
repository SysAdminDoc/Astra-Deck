# Astra Deck — Changelog Archive (v3.x and earlier)

This file holds the historical changelog for Astra Deck **v3.33.0 and
earlier**, including the entire v3.x line, v2.x, v1.x, and v0.x.

Active development moved to a leaner [CHANGELOG.md](CHANGELOG.md) at
the project root which carries `[Unreleased]` and the v4.x line. This
archive was split out 2026-05-25 as the active file approached
6000 lines and was becoming hard to scan in browser-rendered Markdown
viewers; see NEW-8 in the Pass-3 research notes.

Entries below are in their original reverse-chronological order (newest
first within this archive); search by version number or feature name.
