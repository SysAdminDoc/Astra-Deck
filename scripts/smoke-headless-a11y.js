...
const SURFACES = Object.freeze([
    ...
    Object.freeze({
        name: 'transcript-qa',
        page: 'fixture.html',
        httpPath: '/watch?v=abc12345678',
        selector: '.ytkit-ai-qa-modal__body',
        ready: 'Boolean(document.querySelector(".ytkit-ai-qa-turn .ytkit-ai-qa-citation"))',
        prepare: 'globalThis.__ytkitA11y.openTranscriptQa()',
        width: 960,
        height: 800,
        settleMs: 300,
        themes: Object.freeze(['dark', 'light']),
