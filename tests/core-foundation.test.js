...
const selectorPackFiles = [
    ...
    'selector-packs/feedExperimentChips.js',
    'selector-packs/feedPlayables.js',
    'selector-packs/feedPrompt.js',
    'selector-packs/feedSponsored.js',
...
test('feature registry generates a settings schema from registered metadata and defaults', () => {
    ...
    registry.register({
        id: 'qualityMode',
        name: 'Quality Mode',
        description: 'Choose the default quality mode',
        nameKey: 'feature_qualityMode_name',
        descriptionKey: 'feature_qualityMode_desc',
        category: 'Player',
        type: 'select',
