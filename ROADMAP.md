...
- [ ] P3 — Start burning down the 104 light-theme-blind surfaces
  Why: the gate accepts 104 legacy surfaces against 138 that carry a light lane, so YouTube light-theme users still meet near-white text on near-white backgrounds on surfaces nothing flags.
  Evidence: `npm run audit:light-theme` reports 138 covered / 104 accepted; `scripts/light-theme-baseline.json`.
