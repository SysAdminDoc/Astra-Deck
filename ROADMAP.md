...
- **L26** Configurable custom speed presets — we ship a speed control
  ...
  the grid contents (4–8 user-supplied values). competitor userscript ships this and
  it's the most-requested follow-on. [src-competitor userscript]
...
| AGPL relicense (per competitor userscript precedent) | Carried from prior. Astra-Deck is MIT and the maintainer prefers MIT. |
...
- [src-competitor userscript] competitor userscript — https://github.com/TimMacy/competitor userscript
