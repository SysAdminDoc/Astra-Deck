...
| AGPL relicense (per competitor userscript precedent) | Astra-Deck is MIT and the maintainer prefers MIT. Charter-aligned to keep. [src-41] |
...
- [src-29] competitor userscript releases — https://github.com/TimMacy/competitor userscript
